...
const OPTIONAL_ENV = [
  ...
  'PRINCE_BINARY_PATH',
  'PRINCE_CONCURRENCY',
  'PRINCE_LICENSE_ENCODED',
  'PRINCE_MAX_BUFFER_GB',
  'PRINCE_TIMEOUT_SECONDS',
